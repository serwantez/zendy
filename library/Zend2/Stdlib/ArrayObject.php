...
if (version_compare(PHP_VERSION, '5.3.4', 'lt')) {
    class_alias('Zend2\Stdlib\ArrayObject\PhpLegacyCompatibility', 'Zend2\Stdlib\AbstractArrayObject');
} else {
    class_alias('Zend2\Stdlib\ArrayObject\PhpReferenceCompatibility', 'Zend2\Stdlib\AbstractArrayObject');
}
