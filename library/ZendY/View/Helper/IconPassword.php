...
/**
 * Pomocnik do wygenerowania kontrolki hasła z ikoną
 *
 * @author Piotr Zając
 */
class IconPassword extends Widget {
     ...
     * @return string
     */
    public function iconPassword($id, $value = null, array $params = array(), array $attribs = array()) {
        ...
        $input = $this->view->formPassword($id, $value, $attribs['inner']);
