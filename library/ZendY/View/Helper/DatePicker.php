...
/**
 * Pomocnik do wygenerowania kontrolki DatePicker
 *
 * @author Piotr Zając
 */
class DatePicker extends Widget {
    ...
    /**
     * Tworzy kod kontrolki DatePicker
     *
    ...
    public function datePicker($id, $value = null, array $params = array(), array $attribs = array()) {
        ...
        $js[] = sprintf('%s("#%s").datepicker($.datepicker.regional[ "%s" ] );'
        ...
        $html = array();
        $js[] = sprintf('%s("#%s").datepicker("option",%s);'
                , \ZendX_JQuery_View_Helper_JQuery::getJQueryHandler()
                , $attribs['id']
                , $params);
