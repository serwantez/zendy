...
class Label extends Base {
     ...
     * 
     * @param string $id
     * @return \ZendY\Report\Decorator\Label
     */
     ...
     * @param  array $args
     * @return mixed
     * @throws Exception for unsupported methods
     */
            ...
            switch ($placement) {
                ...
                case self::IMPLICIT_PREPEND:
                    ...
                    $label = $view->formLabel(
                            $element->getFullyQualifiedName(), $label . $separator . $content, $options
                    );
                    break;
                ...
                case self::IMPLICIT_APPEND:
                    ...
                    $label = $view->formLabel(
                            $element->getFullyQualifiedName(), $content . $separator . $label, $options
                    );
                    break;
                ...
                default:
                    $label = $view->formLabel(
                            $element->getFullyQualifiedName(), $label, $options
                    );
                    break;
            }
        } else {
