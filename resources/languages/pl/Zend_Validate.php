...
return array(
    ...
    // Zend_Validate_Pesel
    "'%value%' must contain 11 digits" => "'%value%' musi zawierać 11 cyfr",
    
    //Zend_Validate_Nip
    "'%value%' must contain 10 digits" => "'%value%' musi zawierać 10 cyfr",
    "Luhn algorithm (mod-11 checksum) failed on '%value%'" => "Błąd podczas wykonywania algorytmu Luhna (mod-11 checksum) dla wartości '%value%'",
    ...
    // ZendY_Validate_NoLoginExists
    "A user with this name already exists" => "Użytkownik o podanym loginie już istnieje",
    "User with given e-mail already exists" => "Użytkownik z podanym adresem e-mail już istnieje",
    
    "A user with this name doesn't exist" => "Użytkownik o podanym loginie nie istnieje",
    "Wrong password" => "Nieprawidłowe hasło",
    "Wrong login or password" => "Nieprawidłowa nazwa użytkownika lub hasło"
);
