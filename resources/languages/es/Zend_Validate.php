...
// Zend_Validate_GreaterThan
    ...
    "A user with this name already exists" => "El nombre del usuario ya existe",
    "User with given e-mail already exists" => "El usuario con esta dirección de correo electrónico ya existe",
    
    "A user with this name doesn't exist" => "El nombre del usuario no existe",
    "Wrong password" => "Mala contraseña",
    "Wrong login or password" => "Malo nombre de usuario o contraseña"
);
